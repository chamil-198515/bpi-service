...
////
////    Mockito.when(bpiService.getCurrentBpi("eur")).thenReturn(currentBpi);
////    Mockito.when(bpiService.getBpiHistory("eur")).thenReturn(bpiHistory);
//
//    String processBpi = bpiService.findHighestAndLowestBpi("eur");
//
